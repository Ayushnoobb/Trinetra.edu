    ...
    <>
      <section className="section-about ">
        <div className="justify-content-between  d-flex flex-column flex-md-row  p-4">
          <div className="section-about-left mb-3 mb-md-0"  data-aos="fade-up" data-aos-duration="1500" data-aos-delay="300" data-aos-anchor-placement="top-bottom">
            <h4 className="mbr-white  mbr-fonts-style align-left display-4  mb-3">
              About Consultancy
            </h4>
            <div className="mbr-white mbr-section-text mbr-fonts-style align-left display-7 mt-5 "  data-aos="fade-up" data-aos-duration="1500" data-aos-delay="300">
              ...
              planning, and visa procession. Trilochan Educational Service can
            ...
            <div className="mt-3" style={{width:"fit-content"}}>
              <Link to="/about"><Button name="More About Us"/></Link>
            </div>
          </div>
          <div className="section-about-right"  data-aos="fade-up-right" data-aos-duration="1500" data-aos-delay="300">
