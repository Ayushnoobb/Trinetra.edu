    ...
    <>
      <section className="subject">
        <div className="section_wrapper  p-4 ">
          <h5 className="display-4 color-blue mb-5 " data-aos="fade-up" data-aos-duration="1500">Popular Courses</h5>
          <div className="subjects_wrapper">
            <div className="subjects" data-aos="fade-up" data-aos-delay="300" data-aos-anchor-placement="top-center" data-aos-duration="1500">
