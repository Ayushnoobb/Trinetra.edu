                ...
                <div className="address_row d-flex flex-column ">
                  <div className="d-flex gx-2 w-100">
                    ...
                    <div className="address_desc d-flex">
                      <p className="mr-2">9851332907</p>
                      <p className="mr-2">9851341296</p>
                      <p className="mr-2">9848505571</p>
                      <p></p>
                    </div>
                  </div>
                </div>
                ...
                <div className="address_col mt-4 w-50 mb-2">
                  <div className="address_row">
                    <div className="icon_div" name="facebook-logo">
                      <Link
                        href="https://www.facebook.com/profile.php?id=100090400011448"
                        target={"_blank"}
                        rel={"noreferrer"}
                      >
                        <svg
                        ...
                        >
                          ...
                          v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"
                          />
                        </svg>
                      </Link>
                    </div>
